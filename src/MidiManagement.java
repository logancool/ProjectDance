 ...
 */
 int velocity = 0;
MidiBus myBus; 
static DroneListener drone;

public MidiManagement(){
	drone = new DroneListener();
}
/*
 * Set up the Gui
 *
...
public void midiMessage(MidiMessage message) { // You can also use midiMessage(MidiMessage message, String bus_name)
	...
	drone.noteListener((int)(message.getMessage()[1] & 0xFF));
	drone.velocityListener((int)(message.getMessage()[2] & 0xFF));
}
/*
 * delay of messages
 *
...
public void delay(int time) {
  ...
  static public void main(String[] passedArgs) {
    ...
    /**
    drone.addWindowListener(new WindowAdapter() {
		@Override
